...
// 1 Function declaration       
        // 'эта функция хостится, то есть ее множно сначала вызвать, а потом объявить
        //     function sayHello() {
        //        console.log("Hello");
        //     }
// 2  Function expression 
        // эта функция НЕ хостится, то есть ее нужно объявить, а потом вызвать
        // const sayHella = function (){
        //        console.log("Hello");
        //     }
// 3 Стрелочные Arrow function 
        // эта функция НЕ хостится
        // у AF нет arguments
        //   () => {}     вместо function стрелочка
        // const sayHello = () => {
        //        console.log("Hello");
        // }
// 4 IIFE -Immediately Invoked Function Expressions   Немедленно вызываемые функциональные выражения
        // ()()
        // (() => {console.log("Hello");})();
        //  (function () {console.log("Hello");}) ();
        // нет arguments если есть стрелки
        ...
        //   }
        // })(10, 5);
        // стрелок нет - arguments есть 
// 5 CLB call back function
// 6 Anonimus
...
// let getUser = function (userName = 'Vova') {
...
// // значение Аргумента перебивает значение по умолчанию

// let getUser = function (userName = 'Vova', status = 'online', age = 25) {
//         console.log(`Hello ${userName}, status: ${status}, age: ${age}`);
// };

// getUser();
// getUser('Sara', 'OFline');
// getUser('Bob', 'notHere', 35);
